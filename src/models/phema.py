...
class TraditionalEMA:
    """
    half life image refers to the number of images (or training samples) it takes for the 
    EMA weights to incorporate 50% of the current model's weights, effectively describing 
    how fast or slow the EMA weights adapt to changes in the model.
    """
    @torch.no_grad()
