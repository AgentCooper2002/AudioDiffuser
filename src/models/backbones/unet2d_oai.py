...
from .operator_utils import checkpoint
from .utils import default, exists
from .conditioner import LabelEmbedder
...
class QKVAttentionLegacy(nn.Module):
    ...
    def forward(self, qkv):
        ...
        weight = weight.softmax(dim = -1, dtype=th.float32).to(weight.dtype)
...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        if self.num_classes is not None:
            ...
            classes_channels = model_channels * 4
